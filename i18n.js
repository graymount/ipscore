    ...
    loadTranslations() {
        this.translations = {
            ...
            zh: {
                ...
                'debug.final': '最终得分:',
                'debug.risks': '风险因素数量:',
                'debug.deductions': '🔍 扣分详情',
                'debug.norisk': '✅ 未发现任何风险因素，保持满分!',
                'debug.status': '📋 检测项目状态',
                'debug.threats': 'Threat Intelligence:',
                'debug.proxy': 'Proxy/VPN Detection:',
                'debug.geo': 'Geographic Detection:',
                'debug.isp': 'ISP Analysis:',
                'debug.comparison': '💡 对比分析',
                'debug.ipscore': 'ip-score.com分数:',
                'debug.ourscore': '我们的分数:',
                'debug.difference': '差异原因:',
                'debug.consistent': '分数一致',
                'debug.hasdeductions': '存在扣分项如上所示',
                'debug.threatsfound': '{count}/{total} threats found',
                'debug.directconnection': 'Direct Connection',
                'debug.detected': 'Detected {type}',
                'debug.locationconsistent': 'Location Consistent',
                'debug.locationanomaly': 'Location Anomaly',
                'debug.normalisp': 'Normal ISP',
                'debug.cloudprovider': '云服务商/托管IP',
                'debug.severegeoanomalies': '严重地理位置异常',
                'debug.geolocation': '地理位置',
                'debug.finalscore': '最终得分',
                'debug.riskfactors': '风险因素',
                'debug.deductiondetails': '扣分详情',
                'debug.ipinfo': 'IP信息',
